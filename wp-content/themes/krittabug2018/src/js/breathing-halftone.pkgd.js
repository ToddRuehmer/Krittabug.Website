...
Halftone.prototype.render = function() {
  ...
  this.ctx.fillStyle = this.options.bgColor ? ('#' + this.options.bgColor) : this.ctx.fillStyle;
...
Halftone.prototype.renderGrid = function( channel ) {
  ...
  proxy.ctx.fillStyle = this.options.bgColor ? ('#' + this.options.bgColor) : proxy.ctx.fillStyle;
  ...
  proxy.ctx.fillStyle = this.options.fgColor ? ('#' + this.options.fgColor) : proxy.ctx.fillStyle;
